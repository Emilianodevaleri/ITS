...
def test_check_weather2():
    assert check_weather(5.00) == "average", "temperatures between 10 and 20 degrees must be considered as average temperature"
...
def test_check_weather4():
    assert check_weather(13.00) == "average", "temperatures between 10 and 20 must be average temperature"
